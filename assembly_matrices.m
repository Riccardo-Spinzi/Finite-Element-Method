function MODEL = assembly_matrices( ELEMENTS, MODEL )

         % % --------------- FUNCTION INFO ---------------- % %

% assembly_matrices computes the system's mass and stiffness matrix in 
% order to solve the structural problem. It does so by exploiting the 
% pointers in the ELEMENTS.ptrs vector for each element.
%
...
% assembly proportional (K) damping matrix
MODEL.D = MODEL.K * MODEL.damping;
